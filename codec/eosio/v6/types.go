...
// From 'struct proposer_policy'
type ProposerPolicy struct {
	ProposalTime     eos.BlockTimestamp             `json:"proposal_time"`
	ProposerSchedule *eos.ProducerAuthoritySchedule `json:"proposer_schedule"`
}

// From 'struct finalizer_authority_with_string_key'
type FinalizerAuthorityWithStringKey struct {
	Description string `json:"description"`
	Weight      uint64 `json:"weight"`
	PublicKey   string `json:"public_key"`
}

// From 'struct finalizer_policy_with_string_key'
type FinalizerPolicyWithStringKey struct {
	Generation uint32                            `json:"generation"`
	Threshold  uint64                            `json:"threshold"`
	Finalizers []FinalizerAuthorityWithStringKey `json:"finalizers"`
}

// From 'struct finality_data_t'
type FinalityData struct {
	...
	ReversibleBlockMroot                 eos.Checksum256               `json:"reversible_block_mroot"`
	...
	PendingFinalizerPolicy               *FinalizerPolicyWithStringKey `json:"pending_finalizer_policy,omitempty" eos:"optional"`
...
type BlockState struct {
	// From 'struct block_header_state_common_legacy'
	...
	// From 'struct block_state_legacy'
